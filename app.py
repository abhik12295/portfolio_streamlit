...
with st.container():
    ...
    with col4:
        ...
        st.write("Worked on Gaussian Naïve Bayes, Random Forest, and TF-IDF Vectorizer which affected the performance "
                 "of the models")
...
with st.container():
    ...
    with col2:
        ...
        st.write("abhik12295@gmail.com")

    with col3:
        st.image(
            "https://www.freeiconspng.com/uploads/mobile-phone-icon-from-colorful-stickers-part-4-set--256x256-px-13"
            ".png", width=100)
        st.subheader("Call Me At")
        st.write("Phone: (+1) 312 468 5096")
